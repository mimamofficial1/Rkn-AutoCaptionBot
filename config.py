...
class Rkn_Bots(object):
    ...
    # default caption 
    DEF_CAP = os.environ.get("DEF_CAP", "<b><a href='https//:t.me/MRN_RIPPER'>{file_name} Main Telegram Channel: @MRN_RIPPER</a></b>",
    )
    ...
    # admin id  ( required.. 😥)
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '6139759254').split()]
